...
Revision ID: d0bc0e77f635
Revises: 8cba493ac01c
Create Date: 2026-07-24 14:25:52.243456
...
revision: str = 'd0bc0e77f635'
down_revision: Union[str, Sequence[str], None] = '8cba493ac01c'
...
def upgrade() -> None:
    ...
    sa.Column('lawn_size_sqft', sa.Integer(), nullable=True),
